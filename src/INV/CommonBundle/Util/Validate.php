...
class Validate {
    ...
    public static function isEmail($email) {
        return !empty($email) && preg_match(Util::cleanNonUnicodeSupport('/^[a-z\p{L}0-9!#$%&\'*+\/=?^`{}|~_-]+[.a-z\p{L}0-9!#$%&\'*+\/=?^`{}|~_-]*@[a-z\p{L}0-9]+(?:[.]?[_a-z\p{L}0-9-])*\.[a-z\p{L}0-9]+$/ui'), $email);
    }
    ...
    public static function isCarrierName($name) {
        return empty($name) || preg_match(Util::cleanNonUnicodeSupport('/^[^<>;=#{}]*$/u'), $name);
    }
    ...
    public static function isName($name) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[^0-9!<>,;?=+()@#"°{}_$%:]*$/u'), stripslashes($name));
    }
    ...
    public static function isMailName($mail_name) {
        return (is_string($mail_name) && preg_match(Util::cleanNonUnicodeSupport('/^[^<>;=#{}]*$/u'), $mail_name));
    }
    ...
    public static function isMailSubject($mail_subject) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[^<>]*$/u'), $mail_subject);
    }
    ...
    public static function isDiscountName($voucher) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[^!<>,;?=+()@"°{}_$%:]{3,32}$/u'), $voucher);
    }
    ...
    public static function isCatalogName($name) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[^<>;=#{}]*$/u'), $name);
    }
    ...
    public static function isAddress($address) {
        return empty($address) || preg_match(Util::cleanNonUnicodeSupport('/^[^!<>?=+@{}_$%]*$/u'), $address);
    }
    ...
    public static function isCityName($city) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[^!<>;?=+@#"°{}_$%]*$/u'), $city);
    }
    ...
    public static function isValidSearch($search) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[^<>;=#{}]{0,64}$/u'), $search);
    }
    ...
    public static function isReference($reference) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[^<>;={}]*$/u'), $reference);
    }
    ...
    public static function isTagsList($list) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[^!<>;?=+#"°{}_$%]*$/u'), $list);
    }
    ...
    public static function isUrl($url) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[~:#,$%&_=\(\)\.\? \+\-@\/a-zA-Z0-9\pL\pS-]+$/u'), $url);
    }
    ...
    public static function isUnixName($data) {
        return preg_match(Util::cleanNonUnicodeSupport('/^[a-z0-9\._-]+$/ui'), $data);
    }
    ...
    public static function isLabel($label) {
        return (preg_match(Util::cleanNonUnicodeSupport('/^[^{}<>]*$/u'), $label));
    }
