...
class BaseApiManager extends Manager {
    ...
    public function save($data, \Closure $beforeFlush = null) {
        ...
        if (!empty($data['sfFullEntityName'])) {
            ...
            throw new \Exception('The sfFullEntityName key in $data var is not present');
        }
        ...
        $this->getConnection()->transactional(function ($conn) use ($entity, $data, $beforeFlush) {
            ...
            $exist = $this->get('sf.entitysetter')->fromData($entity, $data);
    ...
    public function edit($entity, $data, \Closure $beforeFlush = null) {
        $this->getConnection()->transactional(function ($conn) use ($entity, $data, $beforeFlush) {
            ...
            $em = $this->getEntityManager();
            $existe = $this->get('sf.entitysetter')->fromData($entity, $data);
