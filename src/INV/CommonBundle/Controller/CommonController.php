...
abstract class CommonController extends Controller {
    ...
    public function successRedirect($id = null) {
        return $this->get('inv.manager')->successRedirect($id, $this->getRouteShow(), $this->getRouteIndex());
    }
...
//        $func();
    ...
    public function isXmlHttpRequest() {
        return $this->get('inv.manager')->isXmlHttpRequest();
    }
    ...
    public function renderJson($data, $status = 200, $headers = array()) {
        return $this->get('inv.manager')->renderJson($data, $status, $headers);
    }

    public function getAssetPath() {
        return $this->get('inv.media.file.uploader')::getAssetPath();
    }

    public function serializeJSON($data) {
        return $this->get('inv.manager')->serializeJSON($data);
    }
}
