...
use INV\CommonBundle\Service\EntityGetter;
...
class EntityGetterType extends AbstractType {
    ...
    public function get($attr) {
        if (empty($this->getter)) {
            throw new \Exception('The getter attr has not been initialized');
        }
    ...
    public function getEntity() {
        if (empty($this->entity)) {
            throw new \Exception('The entity attr has not been initialized');
        }
        return $this->entity;
    }
}